...
export class TranslationModule {
  ...
  private loadTranslationFont(language: string): void {
    ...
    const family = language === 'ja'
      ? '"Noto Sans Mono CJK JP", "Yu Gothic", "MS Gothic", monospace'
      : '"Nanum Gothic Coding", "D2Coding", "Noto Sans Mono CJK KR", monospace'
    style.textContent = `
      #app, #app * { font-family: ${family}; }
